...
# Smallest valid 1x1 transparent PNG — decodes correctly so Gemini's image
# pipeline accepts it (the all-zeros fake header passes our magic-byte gate
# but Gemini rejects it as a malformed image).
PNG = (
    b"\x89PNG\r\n\x1a\n"
